<?php
			...
			session_start();
				...
				$sql="select * from shoplogin where username='".$_username."'and password='".$_password."'limit 1 ";
				$res=mysql_query($sql);
				...
				//Insert Query of SQL
				$query = mysql_query("insert into shoplogin(username,password,name,medicines,contact,city,state,country) values ('$username','$password','$name','$med','$numner','$city','$state','$country')");
...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>MediTrack Login and Registration For <span>Shopkeepers</span></h1>
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                           <form method="post" action="shoplogin.php" autocomplete="on"> 
                                <h1>Log in</h1> 
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form method="post" action="shoplogin.php" autocomplete="on">  
								...
								<p> 
                                    <label for="spec" class="uname" data-icon="p">Medicines </label>
                                    <input id="spec" name="med" required="required" type="text" placeholder="eg. Disprin"/>
                                </p>
								<p> 
