<?php
			...
			session_start();
				...
				//Insert Query of SQL
				$query = mysql_query("insert into doclogin(username,password,name,speciality,number,city,state,country) values ('$username','$password','$name','$spec','$numner','$city','$state','$country')");
                        ...
                        <div id="register" class="animate form">
                            <form method="post" action="index.php" autocomplete="on">  
								...
								<p> 
                                    ...
                                    <input id="spec" name="spec" required="required" type="text" placeholder="eg. X8df!90EO"/>
                                </p>
								<p> 
                                    <label for="number" class="uname" data-icon="p">Contact </label>
                                    <input id="number" name="number" required="required" type="text" placeholder="eg. X8df!90EO"/>
                                </p>
								<p> 
                                    <label for="city" class="uname" data-icon="p">City</label>
                                    <input id="city" name="city" required="required" type="text" placeholder="eg. X8df!90EO"/>
                                </p>
                                <p> 
                                    <label for="state" class="uname" data-icon="p">State</label>
                                    <input id="state" name="state" required="required" type="text" placeholder="eg. X8df!90EO"/>
                                </p>
								<p> 
                                    <label for="country" class="uname" data-icon="p">Country</label>
                                    <input id="country" name="country" required="required" type="text" placeholder="eg. X8df!90EO"/>
                                </p>
