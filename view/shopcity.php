...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<header>
				<h1>Meditrack<em></em> <span></br>Customer's of City</span></h1>	
			...
			<div class="component">
				...
				$sql="select patlogin.pcity,patlogin.pname,shoplogin.name from patlogin,shoplogin where patlogin.pcity=shoplogin.city";
