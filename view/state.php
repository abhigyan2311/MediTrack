...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<header>
				<h1>Meditrack <span></br>State wise filtering</span></h1>	
			...
			<div class="component">
				...
				$sql="select patlogin.pstate,doclogin.dstate,patlogin.pname,doclogin.dname,patlogin.diseases from patlogin,doclogin where patlogin.pstate=doclogin.dstate";
				$mydata=mysql_query($sql,$con);
						while($record=mysql_fetch_array($mydata))
						{
							echo "<tr>";
							echo "<td >".$record['pstate']."</td>";
