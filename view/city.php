...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<header>
				<h1>Meditrack <span></br>City wise filtering</span></h1>	
			...
			<div class="component">
				...
				$sql="select patlogin.pcity,doclogin.dcity,patlogin.pname,doclogin.dname,patlogin.diseases from patlogin,doclogin where patlogin.pcity=doclogin.dcity";
