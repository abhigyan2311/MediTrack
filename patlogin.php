<?php
			...
			session_start();
				...
				$sql="select * from patlogin where username='".$_username."'and password='".$_password."'limit 1 ";
				$res=mysql_query($sql);
				...
				$country=$_POST['country'];
                                ...
                                $med=$_POST['med'];
				//Insert Query of SQL
				$query = mysql_query("insert into patlogin(username,password,pname,diseases,contact,pcity,pstate,pcountry,insurance,pmedicine) values ('$username','$password','$name','$dis','$numner','$city','$state','$country','$ins','$med')");
...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>MediTrack Login and Registration For <span>Patients</span></h1>
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                           <form method="post" action="patlogin.php" autocomplete="on"> 
                                <h1>Log in</h1> 
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form method="post" action="patlogin.php" autocomplete="on">  
								...
								<p> 
                                    <label for="spec" class="uname" data-icon="p">Diseases </label>
                                    <input id="spec" name="dis" required="required" type="text" placeholder="eg. Cancer"/>
                                </p>
                                <p> 
                                    <label for="spec" class="uname" data-icon="p">Insurance </label>
                                    <input id="spec" name="ins" required="required" type="text" placeholder="eg. Yes/No"/>
                                </p>
								<p> 
                                ...
                                <p> 
                                    ...
                                    <input id="state" name="state" required="required" type="text" placeholder="eg. Tamil Nadu"/>
                                </p>
								<p> 
...
<p> 
                                    <label for="spec" class="uname" data-icon="p">Medicine</label>
                                    <input id="spec" name="med" required="required" type="text" placeholder="Crocin"/>
                                </p>
